...
@section('scripts')
<script src="{{ asset('js/pages/owner/parent.js') }}"></script>
@endsection
                    ...
                    @if (sizeof($parents))
                        @foreach ($parents as $parent)
                            <tr>
                                ...
                                <td class="text-right">
                                    <button class="btn btn-green no-shadow btn-contact" type="button" data-parent="{{ $parent->id }}" data-toggle="modal" data-target="#contactModal">
                                        <i class="fa fa-address-book mr-2" aria-hidden="true" data-parent="{{ $parent->id }}"></i> Contact
                                    </button>
                                </td>
                            </tr>
                        @endforeach
            ...
            <nav aria-label="pagination">
                <ul class="pagination justify-content-end mb-0">
                    ...
                    <li class="page-item d-flex align-items-center mx-4">
                        {{ $start }} to {{ $end }} of {{ $parents->total() }}
                    </li>
                    @if ($parents->nextPageUrl())
                    <li class="page-item">
                        <a class="page-link" href="{{ $parents->nextPageUrl() }}">
                    @else
                    <li class="page-item disabled">
