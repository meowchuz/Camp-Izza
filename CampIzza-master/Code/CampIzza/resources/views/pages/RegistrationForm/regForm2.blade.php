...
<div class="card">
    <form action="{{ route('handleRegistrationForm2') }}" method="POST">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <input type="text" class="form-control" name="camperDoctor" place_holder="Current doctor's name">
                </div>

                <div class="col">
                    <label for="camperInsurance">Insurance Carrier</label>
                    <input type="text" class="form-control" name="camperInsurance">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <input type="text" class="form-control" name="doctorPhoneNum" place_holder="##########">
                </div>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <input type="text" class="form-control" name="camperChronic" place_holder="Please write all here">
                </div>

                <div class="col">
                    <label for="camperRestrictActivities">Are there any activities at camp that your child cannot
                        participate in?</label>
                    <input type="text" class="form-control" name="camperRestrictActivities">
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <label for="camperAllergies">Will your child be taking any medication at camp?</label>
                    <input type="text" class="form-control" name="camperAllergies" place_holder="Please write all here">
                </div>

                <div class="col">
                    <label for="camperMedicalTreatment">Has your child undergone any medical treatments?</label>
                    <input type="text" class="form-control" name="camperMedicalTreatments">
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col">
                    ...
                    <select class="form-control" name="camperMedicationTaking">
                ...
                <div class="col">
                    ...
                    <select class="form-control" name="camperAll_ImmunizationsReceived">
                        <option selected>Choose...</option>
                        <option value="1">Yes</option>
                        <option value="2">No</option>
                    </select>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <input type="text" class="form-control" name="camperMedicationList" place_holder="Please write all here">
                </div>
                <div class="col">
                    <label for="camper-lastTetanus">If "Yes", date of last tetanus shot</label>
                    <input type="text" class="form-control" name="lastTetanus" place_holder="MM/DD/YYYY">
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <label for="camperComment">Any comments about this camper?</label>
                    <input type="text" class="form-control" name="camperComment" place_holder="Please write all here">
                </div>
                <div class="col">
                    &nbsp;
                </div>
