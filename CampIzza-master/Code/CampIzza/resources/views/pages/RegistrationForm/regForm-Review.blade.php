...
<?php
session_start();
$_SESSION['week1'] = $week1;
$_SESSION['week2'] = $week2;
$_SESSION['week3'] = $week3;
$_SESSION['week4'] = $week4;
$_SESSION['week5'] = $week5;
?>
...
<div class="card">
    <form action="{{ route('handleRegistrationFormTEST') }}" method="POST">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <input type="checkbox" aria-label="" onclick="verify()"> <span class="font-weight-bold">I Agree to terms above</span><br>
            </div>
        </div>
        ...
        <div class="card-footer">
            <div style="text-align:right">
                ...
                <button type="submit" id="submit" class="btn btn-success" disabled>PAY NOW</button>
            </div>
        </div>
    </form>
</div>
