    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('campers') }}">
                        <i class="fa fa-child text-blue"></i> Campers
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('/') }}">
                        <i class="fa fa-users text-orange"></i> Counselors
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('parents') }}">
                        <i class="fa fa-address-book text-green"></i> Parents
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('/') }}">
                        <i class="fa fa-calendar text-yellow"></i> Schedules
                    </a>
                </li>
            </ul>
        </div>
